...
class ArDoCoForSamCodeTraceabilityLinkRecoveryTest extends CodeRunnerBaseTest {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ArDoCoForSamCodeTraceabilityLinkRecoveryTest.class);
    
    // ADDED: Configuration constants
    private static final int DEFAULT_NUM_RUNS = 5;
    private static final String RESULTS_DIR = "results/sam_code_runs";
    ...
    @Test
    @DisplayName("Test ArDoCo for SAM-Code-TLR (PCM) - Single Run")
    void testSamCodeTlrPcm() {
        logger.info("========================================");
        logger.info("Starting SAM-Code TLR Test (PCM) - Single Run");
        logger.info("========================================");
        ...
        runner.setUp(new File(inputModelArchitecture), ArchitectureModelType.PCM, new File(inputCodeModel), 
    ...
    @DisplayName("Test ArDoCo for SAM-Code-TLR (PCM) - Multiple Runs")
    void testSamCodeTlrPcmMultipleRuns(RepetitionInfo repetitionInfo, TestInfo testInfo) {
        int currentRun = repetitionInfo.getCurrentRepetition();
        int totalRuns = repetitionInfo.getTotalRepetitions();
        
        logger.info("========================================");
        logger.info("Starting PCM SAM-Code TLR Test - Run {}/{}", currentRun, totalRuns);
        logger.info("========================================");
    ...
    @Test
    @DisplayName("Test ArDoCo for SAM-Code-TLR (PCM) - Live LLM Mode")
    void testSamCodeTlrPcmLiveLLM() {
        logger.info("========================================");
        logger.info("Starting PCM SAM-Code TLR Test (LIVE LLM MODE)");
        logger.info("========================================");
    ...
    @Test
    @DisplayName("Test ArDoCo for SAM-Code-TLR (PCM) - Configured Multiple Runs")
    void testSamCodeTlrPcmWithMultipleRuns() {
        int numRuns = Integer.parseInt(System.getProperty("test.runs", String.valueOf(DEFAULT_NUM_RUNS)));
        logger.info("========================================");
        logger.info("Starting PCM SAM-Code TLR Test - {} runs configured", numRuns);
        logger.info("========================================");
    ...
    @Test
    @DisplayName("Test ArDoCo for SAM-Code-TLR (UML) - Single Run")
    void testSamCodeTlrUml() {
        logger.info("========================================");
        logger.info("Starting SAM-Code TLR Test (UML) - Single Run");
        logger.info("========================================");
        ...
        runner.setUp(new File(inputModelArchitectureUml), ArchitectureModelType.UML, new File(inputCodeModel), 
                     additionalConfigsMap, new File(outputDir));
    ...
    @DisplayName("Test ArDoCo for SAM-Code-TLR (UML) - Multiple Runs")
    void testSamCodeTlrUmlMultipleRuns(RepetitionInfo repetitionInfo, TestInfo testInfo) {
        int currentRun = repetitionInfo.getCurrentRepetition();
        int totalRuns = repetitionInfo.getTotalRepetitions();
        
        logger.info("========================================");
        logger.info("Starting UML SAM-Code TLR Test - Run {}/{}", currentRun, totalRuns);
        logger.info("========================================");
    ...
    @Test
    @DisplayName("Test ArDoCo for SAM-Code-TLR (UML) - Live LLM Mode")
    void testSamCodeTlrUmlLiveLLM() {
        logger.info("========================================");
        logger.info("Starting UML SAM-Code TLR Test (LIVE LLM MODE)");
        logger.info("========================================");
        logger.warn("⚠️  This test will make actual API calls and incur costs! ⚠️");
    ...
    @Disabled("Disabled for faster builds. Enable to test UML with multiple runs.")
    @Test
    @DisplayName("Test ArDoCo for SAM-Code-TLR (UML) - Configured Multiple Runs")
    void testSamCodeTlrUmlWithMultipleRuns() {
        int numRuns = Integer.parseInt(System.getProperty("test.runs", String.valueOf(DEFAULT_NUM_RUNS)));
        logger.info("========================================");
        logger.info("Starting UML SAM-Code TLR Test - {} runs configured", numRuns);
        logger.info("========================================");
    ...
    private static void printSummaryForModelType(SortedMap<Integer, RunResult> results, String modelType) {
        ...
        logger.info("\n\n");
        logger.info("########################################");
        logger.info("#     SAM-CODE TLR TEST SUMMARY        #");
    ...
    private static void exportResultsToCSV(SortedMap<Integer, RunResult> results, String modelType) {
        try {
            ...
            File csvFile = new File(resultsDir, "sam_code_results_" + modelType + "_" + timestamp + ".csv");
